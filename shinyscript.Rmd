...
par4 <- "The plot above shows the total number of records broken each year over time. The color of the line indicates if the year took place before the 2009 ban or after. As we can observe, the number of records broken each year remains stable until the mid-1950s, which is around the time that many events were created. During this time, backstroke, breaststroke, and the IM were all created which explains the spike in the number of records broken. These rates then die down until we see a large spike in 2000, the beginning of the fast-suit era."
